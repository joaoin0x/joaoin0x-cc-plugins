# ClickUp Code Review Plugin (v5.2.8)
...
├── hooks/
│   ├── hooks.json                   # Plugin-bundled PreToolUse matchers (v5.2.8)
...
├── skills/
│   ├── shared/                      # Shared protocols (v5.2.8 — referenced by all agents)
