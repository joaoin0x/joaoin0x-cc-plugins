# Testing Protocol Reference (v5.2.6)
...
## Snapshot-First Methodology (OBRIGATÓRIO — v5.2.6)
...
## Human-First Usage & Critical Testing (OBRIGATÓRIO — v5.2.6)
...
FASE 4: PENSAMENTO CRÍTICO & STRESS TEST (v5.2.6)
...
## Design System — Source of Truth (Level 2 — v5.2.6)
...
## Visual/UI Quality Verification (Level 2 — v5.2.6)
...
## Verificação por Tipo de Ticket (v5.2.6)
