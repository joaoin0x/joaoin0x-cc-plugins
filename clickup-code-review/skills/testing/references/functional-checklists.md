# Functional Test Checklists (v5.2.8)
...
## Visual/UI Quality (OBRIGATÓRIO em funcional/completo — v5.2.8)
...
## Critical Thinking & Edge Cases (OBRIGATÓRIO em funcional/completo — v5.2.8)
