...
**Three complementary hook systems (v5.2.7):**
...
**Version update (v5.2.7):** If the installed hook is outdated (from a previous plugin version), Step 6.0 detects the version mismatch and offers to re-install from the latest template.
