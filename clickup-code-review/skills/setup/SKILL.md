...
**Three complementary hook systems (v5.2.1):**
...
**Version update (v5.2.1):** If the installed hook is outdated (from a previous plugin version), Step 6.0 detects the version mismatch and offers to re-install from the latest template.
...
```
AskUserQuestion: "Hook auto-approve existente está desactualizado (versão anterior do plugin). Actualizar para a versão v5.2.1?"
Options:
